// Copiez ici le code complet de l'artifact trading-journal-enhanced
// En ajoutant cette configuration en haut :
  ...
  return (
    <div className={`min-h-screen ${bgClass} ${textClass} transition-colors`}>
      ...
      <main className="p-4">
        ...
        {/* Les autres vues restent identiques... */}
        {/* Trades */}
        {currentView === 'trades' && (
          <div className={`${cardClass} rounded-xl p-4`}>
            ...
            <div className={`${cardClass} p-6 rounded-xl border ${borderClass}`}>
              ...
              <div className="space-y-2">
                {(() => {
                  ...
                  return Object.entries(months).map(([month, pl]) => (
